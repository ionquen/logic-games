    ...
    <article className={styles.manual}>
      ...
      <section>
        ...
        <ul>
          ...
          <li>Не совершать DOS и DDOS атаки. Наш сервер работает только благодаря энтузиазму разработчика. Роняя его вы лишаете других пользователей ресурса, созданного без каких-либо корыстных целей </li>
        </ul>
      </section>
    </article>
  )
